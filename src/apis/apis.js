...
const instance = axios.create({ baseURL: ' http://192.168.1.18:8080/'})
...
export const productsApi = async() =>{
    try{
        let response = await axios.get(' http://192.168.1.18:8080/products/fetchProducts');
...
export const loginWithToken = async() => {
    try{
        ...
        let response = await axios.get(' http://192.168.1.18:8080/user/loginWithToken', {headers: {'access-token' : token}}); 
        return response;
    }
    catch(err) {
        console.log(err);

...
export const productsApi = async() =>{
    try{
        let response = await axios.get(' http://192.168.1.13:8080/products/fetchProducts');
...
export const loginWithToken = async() => {
    try{
        ...
        let response = await axios.get(' http://192.168.1.13:8080/user/loginWithToken', {headers: {'access-token' : token}}); 
        return response;
    }
    catch(err) {
        console.log(err);
